<?php
if ( ! function_exists( 'mixxcazt_elementor_get_render_attribute_string' ) ) {
	function mixxcazt_elementor_get_render_attribute_string($element, $obj) {
		return $obj->get_render_attribute_string($element);
	}
}
if ( ! function_exists( 'mixxcazt_elementor_parse_text_editor' ) ) {
	function mixxcazt_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'mixxcazt_elementor_get_strftime' ) ) {
	function mixxcazt_elementor_get_strftime( $instance, $obj ) {
		$string = '';
