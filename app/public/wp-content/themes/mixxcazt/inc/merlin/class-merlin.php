...
//        add_action( 'import_start', array( $this, 'before_content_import_setup' ) );
    ...
    public function after_content_import_setup() {
        // Set static homepage.
        $homepage = mixxcazt_get_page_by_title( apply_filters( 'merlin_content_home_page_title', 'Home' ) );
        ...
        $blogpage = mixxcazt_get_page_by_title( apply_filters( 'merlin_content_blog_page_title', 'Blog' ) );
    ...
    public function before_content_import_setup() {
        ...
        $hello_world = mixxcazt_get_page_by_title( 'Hello World!', OBJECT, 'post' );
