<?php
/**
 * Mixxcazt_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Mixxcazt_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Mixxcazt_Product_Brand_List_Walker', false)) :

	class Mixxcazt_Product_Brand_List_Walker extends Walker {
