<?php
/**
 * Mixxcazt WooCommerce Adjacent Products Class
 *
 * @package  mixxcazt
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Mixxcazt_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Mixxcazt WooCommerce Adjacent Products Class
	 */
	class Mixxcazt_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'mixxcazt_woocommerce_adjacent_query_args', $args ) );
